...
pub fn build_registry() -> PassRegistry {
    ...
    r.register(&asar::ASAR_PASS);      // Electron asar unpacking
    r.register(&bundle::BUNDLE_PASS);  // webpack/vite bundle unpacking
    r.register(&js::JS_PASS);          // JavaScript deobfuscation
